...
// https://contest.yandex.ru/contest/40236/run-report/117792182/
...
int main() {  // Пробелы вокруг скобок, пропуск строк до и после объявления / реализации функций, классов и прочего
  size_t first_cathetus, second_cathetus;  // Понятный нейминг + пользуемся натуральностью чисел из условия выбирая тип
